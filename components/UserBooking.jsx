...
const UserBooking = ({ user }) => {
  ...
  const checkBetweenTimeAndDate = () => {
    ...
    const formattedScheduleDate = Number(selectedUserBooking.date?.split("-").join(""));
    const formattedScheduleTime = Number(selectedUserBooking.time?.split(":").join(""));
    ...
    console.log({
      ...
      formattedScheduleTime:
        formattedScheduleTime - cancelValidationValueInHours,
    });
